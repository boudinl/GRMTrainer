...
export default function AdminAddNewProduct() {
  ...
  const filteredFormControls = adminAddProductformControls.filter(
    (controlItem) => {
    ...
    <div className="w-full mt-5 mr-0 mb-0 ml-0 relative">
      <div className="flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl relative text-black">
        <div className="w-full mt-6 mr-0 mb-0 ml-0 space-y-8">
          ...
          <div className="flex gap-4 mt-4">
            {formData.optionalImagesUrl.length > 0 &&
              formData.optionalImagesUrl.map((imageUrl, index) => (
                <div key={index} className="w-24 h-24 relative">
                  ...
                  <button
                    onClick={() => {
                      ...
                      setFormData({
                        ...formData,
                        optionalImagesUrl: formData.optionalImagesUrl.filter(
                          (_, idx) => idx !== index
                        ),
                      });
                    }}
